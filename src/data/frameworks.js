...
export const appTeamMembers = [
  ...
  "Александр Горшенин (alexandr268)",
  "Булат Гаязов (brgayazov)",
  "Евгений Прокофьев (prkkofev)",
  "Иван Шиляев (spotivan)",
  "Кирилл Курдюков (kurdyukov-kir)",
  "Константин Прокопенко (zkpo)",
  "Николай Перфилов (pnv1)",
  "Олег Овчарук (ovcharuk)",
  "Тимофей Кулин (rekby)",
  "Я Владислав Поляков (polrk)",
];
